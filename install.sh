...
#  Версия 3.10.9-Stable (финальная, с поддержкой IPv6)
# =============================================================================

echo "=== Установка системы селективной маршрутизации (AmneziaWG + WARP) v3.10.9-Stable ==="
...
echo "=============================================="
echo "Установка v3.10.9-Stable завершена. Запускаю первый импорт..."
echo "=============================================="
sh /etc/storage/ipset_update.sh
